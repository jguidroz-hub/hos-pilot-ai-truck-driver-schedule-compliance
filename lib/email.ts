...
const FROM = process.env.EMAIL_FROM || 'HOS Pilot - AI Truck Driver Schedule & Compliance <noreply@example.com>';
const APP_NAME = 'HOS Pilot - AI Truck Driver Schedule & Compliance';
